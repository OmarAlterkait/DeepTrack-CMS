...
# with command line options: step2 --conditions auto:phase2_realistic_T14 -s DIGI:pdigi_valid,L1,L1TrackTrigger,DIGI2RAW,HLT:@fake2 --datatier GEN-SIM-DIGI-RAW -n 10 --geometry Extended2026D41 --era Phase2C8 --eventcontent FEVTDEBUGHLT --filein file:step1.root --fileout file:step2.root
