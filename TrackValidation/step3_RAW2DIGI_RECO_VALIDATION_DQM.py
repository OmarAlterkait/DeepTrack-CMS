...
# with command line options: step3 --conditions auto:phase2_realistic_T14 -n 10 --era Phase2C8 --eventcontent RECOSIM,DQM --runUnscheduled -s RAW2DIGI,RECO:reconstruction_trackingOnly,VALIDATION:@trackingOnlyValidation,DQM:@trackingOnlyDQM --datatier GEN-SIM-RECO,DQMIO --geometry Extended2026D41 --filein file:step2.root --fileout file:step3.root
